 ...
 */
public class ScheduleResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.exacttarget.wsdl.partnerapi.ScheduleResponse
{
    
    public ScheduleResponseImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.exacttarget.wsdl.partnerapi.ScheduleResponse.Results getResults()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.exacttarget.wsdl.partnerapi.ScheduleResponse.Results target = null;
            target = (com.exacttarget.wsdl.partnerapi.ScheduleResponse.Results)get_store().find_element_user(RESULTS$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setResults(com.exacttarget.wsdl.partnerapi.ScheduleResponse.Results results)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.exacttarget.wsdl.partnerapi.ScheduleResponse.Results)get_store().add_element_user(RESULTS$6);
            }
            target.set(results);
        }
    }
     ...
     */
    public com.exacttarget.wsdl.partnerapi.ScheduleResponse.Results addNewResults()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ResultsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.exacttarget.wsdl.partnerapi.ScheduleResponse.Results
    {
