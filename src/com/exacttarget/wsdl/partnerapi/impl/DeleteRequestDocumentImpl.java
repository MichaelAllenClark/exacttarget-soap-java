 ...
 */
public class DeleteRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.exacttarget.wsdl.partnerapi.DeleteRequestDocument
{
     ...
     */
    public com.exacttarget.wsdl.partnerapi.DeleteRequestDocument.DeleteRequest getDeleteRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.exacttarget.wsdl.partnerapi.DeleteRequestDocument.DeleteRequest target = null;
            target = (com.exacttarget.wsdl.partnerapi.DeleteRequestDocument.DeleteRequest)get_store().find_element_user(DELETEREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDeleteRequest(com.exacttarget.wsdl.partnerapi.DeleteRequestDocument.DeleteRequest deleteRequest)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.exacttarget.wsdl.partnerapi.DeleteRequestDocument.DeleteRequest)get_store().add_element_user(DELETEREQUEST$0);
            }
     ...
     */
    public com.exacttarget.wsdl.partnerapi.DeleteRequestDocument.DeleteRequest addNewDeleteRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class DeleteRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.exacttarget.wsdl.partnerapi.DeleteRequestDocument.DeleteRequest
    {
        ...
        public com.exacttarget.wsdl.partnerapi.DeleteOptions getOptions()
        {
            synchronized (monitor())
            {
                ...
                target = (com.exacttarget.wsdl.partnerapi.DeleteOptions)get_store().find_element_user(OPTIONS$0, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public void setOptions(com.exacttarget.wsdl.partnerapi.DeleteOptions options)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (com.exacttarget.wsdl.partnerapi.DeleteOptions)get_store().add_element_user(OPTIONS$0);
                }
                target.set(options);
            }
        }
         ...
         */
        public com.exacttarget.wsdl.partnerapi.DeleteOptions addNewOptions()
        {
            synchronized (monitor())
            {
                check_orphaned();
