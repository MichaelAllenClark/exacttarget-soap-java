 ...
 */
public class UpdateRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.exacttarget.wsdl.partnerapi.UpdateRequestDocument
{
    
    public UpdateRequestDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName UPDATEREQUEST$0 = 
     ...
     */
    public com.exacttarget.wsdl.partnerapi.UpdateRequestDocument.UpdateRequest getUpdateRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.exacttarget.wsdl.partnerapi.UpdateRequestDocument.UpdateRequest target = null;
            target = (com.exacttarget.wsdl.partnerapi.UpdateRequestDocument.UpdateRequest)get_store().find_element_user(UPDATEREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setUpdateRequest(com.exacttarget.wsdl.partnerapi.UpdateRequestDocument.UpdateRequest updateRequest)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.exacttarget.wsdl.partnerapi.UpdateRequestDocument.UpdateRequest)get_store().add_element_user(UPDATEREQUEST$0);
            }
     ...
     */
    public com.exacttarget.wsdl.partnerapi.UpdateRequestDocument.UpdateRequest addNewUpdateRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class UpdateRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.exacttarget.wsdl.partnerapi.UpdateRequestDocument.UpdateRequest
    {
        ...
        public com.exacttarget.wsdl.partnerapi.UpdateOptions getOptions()
        {
            synchronized (monitor())
            {
                ...
                target = (com.exacttarget.wsdl.partnerapi.UpdateOptions)get_store().find_element_user(OPTIONS$0, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public void setOptions(com.exacttarget.wsdl.partnerapi.UpdateOptions options)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (com.exacttarget.wsdl.partnerapi.UpdateOptions)get_store().add_element_user(OPTIONS$0);
                }
                target.set(options);
            }
        }
         ...
         */
        public com.exacttarget.wsdl.partnerapi.UpdateOptions addNewOptions()
        {
            synchronized (monitor())
            {
                check_orphaned();
