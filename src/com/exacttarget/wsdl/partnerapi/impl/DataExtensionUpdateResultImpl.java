 ...
 */
public class DataExtensionUpdateResultImpl extends com.exacttarget.wsdl.partnerapi.impl.UpdateResultImpl implements com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult
{
    
    public DataExtensionUpdateResultImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.KeyErrors getKeyErrors()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.KeyErrors target = null;
            target = (com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.KeyErrors)get_store().find_element_user(KEYERRORS$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setKeyErrors(com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.KeyErrors keyErrors)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.KeyErrors)get_store().add_element_user(KEYERRORS$2);
            }
     ...
     */
    public com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.KeyErrors addNewKeyErrors()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.ValueErrors getValueErrors()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.ValueErrors target = null;
            target = (com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.ValueErrors)get_store().find_element_user(VALUEERRORS$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setValueErrors(com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.ValueErrors valueErrors)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.ValueErrors)get_store().add_element_user(VALUEERRORS$4);
            }
     ...
     */
    public com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.ValueErrors addNewValueErrors()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class KeyErrorsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.KeyErrors
    {
     ...
     * This is a complex type.
     */
    public static class ValueErrorsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.exacttarget.wsdl.partnerapi.DataExtensionUpdateResult.ValueErrors
    {
